                        ...
                        <div className="box-paper">
                            ...
                            <div className="group-info">
                                    <div className="info-item">
                                        ...
                                        <p className="info-value">: {gin.user_created_name || "---"}</p>
                                    </div>
                                    <div className="info-item">
                                        <p className="info-title">Nhân viên cân bằng</p>
                                        <p className="info-value">: {gin.user_balanced_name || "---"}</p>
                                    </div>
                                    <div className="info-item">
                    ...
                    <div className="box-products">
                        <div className="box-paper">
                            ...
                            <div className="box-table">
                                <GINProductsTable productsList={filteredProducts} colsToRender={colsToRender} isView={true} />
