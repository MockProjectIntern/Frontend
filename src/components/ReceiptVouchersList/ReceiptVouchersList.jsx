                    ...
                    <div className="right__table-scroller">
                        <div className="box-scroller">
                            <div className="group-scroller-btns">
                                <button className={`btn-scroller ${active.all}`} onClick={() => handleChangeActive("all")}>Tất cả phiếu thu</button>
                                <button className={`btn-scroller ${active.completed}`} onClick={() => handleChangeActive("completed")}>Phiếu thu hoàn thành</button>
                                <button className={`btn-scroller ${active.cancelled}`} onClick={() => handleChangeActive("cancelled")}>Phiếu thu đã hủy</button>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="box-search-filter-btns">
                            <div className="box-search">
                                <div className="box-input">
                                    ...
                                    <input placeholder='Tìm kiếm theo mã phiếu thu, mã chứng từ gốc'
                                        type="text"
                                        name="query"
                                        id=""
                                        autoComplete='on'
