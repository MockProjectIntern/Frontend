        ...
        <>
            <div className="right__navbar">
                <div className="box-navbar">
                    ...
                    <div className="btn-toolbar">
                        <button className="btn btn-outline-primary" onClick={() => navigate("/admin/payment_vouchers")}>
                                                        ...
                                                        {dataBody.recipient_name === ""
                                                            ? dataBody.recipient_group === "SUP"
                                                                ? "Chọn nhà cung cấp" : dataBody.recipient_group === "USR"
                                                                    ? "Chọn khách hàng" : "Chọn nhân viên" : dataBody.recipient_name}
                                                        <FontAwesomeIcon icon={faCaretDown} />
                                                    </button>
                                            ...
                                            <div className="form-item">
                                                <label htmlFor="id" className="form-label">
                                                    ...
                                                    <UncontrolledTooltip
                                                        ...
                                                        target="idCaption"
                                                    >
                                                        Mã phiếu chi không trùng lặp. Nếu để trống mã phiếu tự sinh với tiền tố <strong>PVN</strong>
                                                    </UncontrolledTooltip>
                                                </label>
